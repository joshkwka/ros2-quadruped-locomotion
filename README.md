...
- `quadruped_locomotion`: The high-level "Brain" of the robot. This C++ package utilizes the **Eigen** library for high-performance linear algebra, handling gait scheduling, and Inverse Kinematics (IK). It translates velocity commands into synchronized joint-space trajectories for all 12 degrees of freedom. (In-Progress)
